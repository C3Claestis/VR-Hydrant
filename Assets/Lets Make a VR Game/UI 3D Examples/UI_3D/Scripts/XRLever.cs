...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    /// </summary>
    public class XRLever : XRBaseInteractable, IPunObservable
    {
        ...
        void SetValue(bool isOn, bool forceRotation = false)
        {
            ...
            m_PhotonView.RPC("RPC_SetValue", RpcTarget.All, m_Value, forceRotation);
        }
        ...
        [PunRPC]
        void RPC_SetValue(bool isOn, bool forceRotation)
        {
            m_Value = isOn;
        ...
        public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
        {
            ...
            {
                m_Value = (bool)stream.ReceiveNext();
                SetValue(m_Value, true);
            }
        }
    }
